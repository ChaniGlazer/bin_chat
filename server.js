...
// שלוחת ימות המשיח (מודול API) צריכה להצביע ל-<כתובת-השרת>/yemot/<username>
// (שם המשתמש כפי שמוגדר ב-USERS_JSON, ראו users.js) - חייב להישאר לפני requireAuth,
// זו קריאה חיצונית משרת ימות, לא מהדפדפן
