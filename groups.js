...
// הודעה לקבוצה נשלחת רק דרך Push (לא TTS/צינתוק) - ראו chat.js deliverGroupMessage.
const db = require('./db');
...
function ensureDefaultGroup() {
  db.prepare('INSERT OR IGNORE INTO groups (name) VALUES (?)').run(DEFAULT_GROUP_NAME);
